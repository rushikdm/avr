...
/*
avr-gcc -Wall  -Os -mmcu=atmega8a -o htimer3.o htimer3.cpp -std=c++11
avr-objcopy -j .text -j .data -O ihex htimer3.o htimer3.hex
avrdude -p ATmega8 -c arduino -P COM3 -b 19200 -U flash:w:htimer3.hex:i -F
*/
